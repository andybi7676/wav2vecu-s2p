...
# len_for_bucket_root = '/work/b07502072/corpus/u-s2s/audio/cv4/es/w2v_manifest/wo_sil/train_all'
len_for_bucket_root = '/work/c/LibriTTS/manifest'
...
def secs_to_time(total_secs):
    ...
    secs = total_secs % 60
    return f"{hrs} hrs {mins} mins {secs} secs ({total_secs} secs)."
