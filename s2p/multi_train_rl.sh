...
TASK_DATA=/work/b07502072/corpus/u-s2s/audio/en_feats/librispeech/large_clean/precompute_pca512_RL_iter1_mean
...
EXP_NAME=ls_100h/large_clean_RL_iter1/ls_wo_lv_g2p_all
