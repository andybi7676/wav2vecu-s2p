...
KENLM_PATH=/work/b07502072/corpus/u-s2s/text/voxpopuli_trans/de/prep/phones/lm.phones.filtered.04.bin
EXP_NAME=voxpopuli_de/xlsr_new/vox_trans
...
PYTHONPATH=$FAIRSEQ_ROOT PREFIX=$PREFIX fairseq-hydra-train \
    ...
    distributed_training.distributed_world_size=1 'common.seed=range(0,2)' \
